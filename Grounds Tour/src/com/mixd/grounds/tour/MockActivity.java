...
public class MockActivity extends Activity {
    ...
    public void check() {
        /*
         * task = new TimerTask() { public void run() { handler.post(new
         * Runnable() { public void run() {
         */
        ArrayList<Object> array =
                Helper.getMockStop(stopNum, latitude, longitude,
                        (double) finalDest.getLatitudeE6() / 1000000,
                        (double) finalDest.getLongitudeE6() / 1000000,
                        MockActivity.activity);

        float bearingToStop =
                (float) Helper.latLngBearingDeg(latitude, longitude,
                        (double) finalDest.getLatitudeE6() / 1000000,
                        (double) finalDest.getLongitudeE6() / 1000000);
        ...
        double distance =
                Helper.latLngDist(latitude, longitude,
                        (double) finalDest.getLatitudeE6() / 1000000,
                        (double) finalDest.getLongitudeE6() / 1000000);
        ...
        if (array != null) {
            ...
            if (nextNum != stopNum) {
                if (nextNum != firstNum) {
                    ...
                    stopLatField.setText(String
                            .valueOf((double) stopLat / 1000000));
                    stopLonField.setText(String
                            .valueOf((double) stopLon / 1000000));

                    finalDest = new GeoPoint(stopLat, stopLon);

                    AlertDialog ad =
                            new AlertDialog.Builder(MockActivity.activity)
                                    .create();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < 9; i++) {
            ...
            if (finalDest == null) {
                finalDest =
                        new GeoPoint(currentDest.getLatitudeE6(),
        ...
        stopLatField
                .setText(String.valueOf((double) finalDest.getLatitudeE6() / 1000000));
        stopLonField
                .setText(String.valueOf((double) finalDest.getLongitudeE6() / 1000000));
        firstNum = stopNum;
