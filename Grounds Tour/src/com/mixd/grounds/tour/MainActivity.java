            ...
            for (int i = 0; i < 9; i++) {
                ...
                if (finalDest == null) {
                    ...
                    if (distanceC < distanceF) {
                        ...
                        nextLat.setText((double) finalDest.getLatitudeE6()
                                / 1000000 + "");
                        nextLng.setText((double) finalDest.getLongitudeE6()
                                / 1000000 + "");
                    }
                }
            }
    ...
    public void onLocationChanged(Location location) {
        ...
        if (check) {
            ArrayList<Object> newArray =
                    Helper.getCurrentStop(lat, lon, nextStop, this);

            int newInt = 0;
            int thisInt = 0;

            float bearingToStop =
                    (float) Helper.latLngBearingDeg(lat, lon,
            ...
            double distToStop =
                    Helper.latLngDist(location.getLatitude(),
